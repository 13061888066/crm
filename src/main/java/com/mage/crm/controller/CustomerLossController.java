...
public class CustomerLossController extends BaseController {
    ...
    @RequestMapping("toReprievePage/{lossId}")
    public String toReprievePage(@PathVariable("lossId") Integer lossId, Model model){
    ...
    public MessageModel updateCustomerLossState(Integer lossId, String lossReason){
        ...
        return createDefaultMessageModel("流失操作执行成功");
    }
}
