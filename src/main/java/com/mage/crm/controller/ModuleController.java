...
public class ModuleController extends BaseController {
    ...
    public List<ModuleDto> queryAllsModuleDtos(Integer rid){
        ...
        List<ModuleDto> moduleDtos = moduleService.queryAllsModuleDtos(rid);
        return moduleDtos;
    }
    ...
    public MessageModel insert(Module module){
        ...
        return  createDefaultMessageModel("模块添加成功");
    }
    ...
    public MessageModel update(Module module){
        ...
        return  createDefaultMessageModel("模块修改成功");
    }
    ...
    public MessageModel delete(Integer[] ids){
        ...
        return  createDefaultMessageModel("模块删除成功");
    }
}
