...
public class CustomerLossService {
    ...
    public Map<String, Object> queryCustomerLossesByParams(CustomerLossQuery customerLossQuery) {
        ...
        PageInfo<CustomerLoss> customerLossPageInfo = new PageInfo<>(customerLosses);
...
//    }
    ...
    public Map<String, Object> queryCustomerLossesById(Integer id) {
    ...
    public void updateCustomerLossState(Integer id, String reason) {
        ...
        AssertUtil.isTrue(customerDao.updateCustomerState((String) map.get("cusNo")) <1,"操作失败");
    }
}
